    ...
    var Cascader = {
            ...
            bindEvent: function (o) {
                ...
                list.on('click', "li", function () {
                    ...
                    $(this).addClass('me-cascader-menu-item-active').siblings().removeClass('me-cascader-menu-item-active me-ion-load-c');
                    ...
                    if (indexParent < (o.num - 1)) {
                        ...
                        list.find('li').removeClass('me-ion-load-c').addClass('me-ion-o-arrow-right');
