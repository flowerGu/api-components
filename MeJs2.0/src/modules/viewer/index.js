...
var TEMPLATE = '<div class="viewer-container">' + '<div class="viewer-canvas"></div>' + '<div class="viewer-footer">' + '<div class="viewer-title"></div>' + '<ul class="viewer-toolbar">' + '<li class="viewer-zoom-in" data-action="zoom-in"></li>' + '<li class="viewer-zoom-out" data-action="zoom-out"></li>' + '<li class="viewer-one-to-one" data-action="one-to-one"></li>' + '<li class="viewer-reset" data-action="reset"></li>' + '<li class="viewer-prev" data-action="prev"></li>' + '<li class="viewer-play" data-action="play"></li>' + '<li class="viewer-next" data-action="next"></li>' + '<li class="viewer-rotate-left" data-action="rotate-left"></li>' + '<li class="viewer-rotate-right" data-action="rotate-right"></li>' + '<li class="viewer-flip-horizontal" data-action="flip-horizontal"></li>' + '<li class="viewer-flip-vertical" data-action="flip-vertical"></li>' + '</ul>' + '<div class="viewer-navbar">' + '<ul class="viewer-list"></ul>' + '</div>' + '</div>' + '<div class="viewer-tooltip"></div>' +'<div class="viewer-button-close" data-action="hide"></div>'+ '<div class="viewer-button" data-action="mix"></div>' + '<div class="viewer-player"></div>' + '</div>';
...
var methods = {
  ...
  hide: function hide() {
    ...
    if (self.transitioning || !self.visible) {
      return self;
    }
...
var Viewer = function () {
  ...
  createClass(Viewer, [{
      ...
      if (options.inline) {
       ...
       /*******************************************************************************************************************************************/ 
        ...
        addListener(element, 'click', function(e){
            ...
            //console.log(1111)
            //self.onStart = proxy(self.start, self)
            //self.view();
            var e = getEvent(event);
            if(isTrue){
                self.reset();
                $('.viewer-navbar').find('li').removeClass('viewer-active')
                ...
                //self.canvas.getElementsByTagName('img')[0].src = e.target;
                //$('.viewer-fullscreen').click();
                //$('.viewer-navbar').find('li').removeClass('viewer-active')
                $('.viewer-navbar').find('li').eq(index).addClass('viewer-active');
                self.index = +index;
    ...
    value: function build() {
      ...
      self.button_close = button_close = getByClass(viewer, 'viewer-button-close')[0];
      ...
      if (options.inline) {
        ...
        addClass(button_close, 'viewer-close');
        setStyle(viewer, {
          zIndex: options.zIndexInline
        });
